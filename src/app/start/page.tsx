...
export default function StartPage() {
  ...
  const handleCopyUrl = async () => {
    ...
    const inviteUrl = `${window.location.origin}/start?join=${encodeURIComponent(createdRoomUrl)}`;
      ...
      <div className="w-full max-w-md space-y-10">
        ...
        {mode === "host" && (
          <div className="space-y-6">
              ...
              <div className="card-shadow rounded-3xl p-6 bg-[var(--background)]">
                <div className="section-content">
                  <div className="space-y-2">
                    <label className="text-label">参加人数</label>
              ...
              <div className="card-shadow rounded-3xl p-6 bg-[var(--background)]">
                <div className="section-content">
                  <div className="space-y-3">
                    <p className="text-label">ルームが作成されました</p>
                    <div className="flex items-center gap-2">
                      <input type="text" value={createdRoomUrl} readOnly className="input-field flex-1 text-sm bg-[var(--muted)]" />
                      <button onClick={handleCopyUrl} className="btn-secondary p-3" title="URLをコピー">
                  ...
                  <div className="space-y-2">
                    <label className="text-label">あなたの名前</label>
                    <input
                      type="text"
                      placeholder="名前を入力"
                      value={userName}
                  ...
                  <button onClick={handleEnterRoomAsHost} disabled={isJoining} className="btn-primary w-full">
            ...
            <button onClick={resetToInitial} className="text-sm text-[var(--muted-foreground)] hover:text-[var(--foreground)] w-full text-center">
              ← 戻る
            </button>
          </div>
        )}
          ...
          <div className="space-y-6">
            <div className="card-shadow rounded-3xl p-6 bg-[var(--background)]">
              <div className="section-content">
                ...
                <button onClick={handleJoinRoomAsParticipant} disabled={isJoining} className="btn-primary w-full">
